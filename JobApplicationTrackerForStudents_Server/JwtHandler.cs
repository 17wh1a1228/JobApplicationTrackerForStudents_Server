...
namespace JobApplicationTrackerForStudents_Server
{
    public class JwtHandler
    {
        ...
        public JwtHandler(IConfiguration configuration, UserManager<ApplicationsUser> userManager)
        {
            _configuration = configuration;
            _userManager = userManager;
        }

        public async Task<JwtSecurityToken> GetTokenAsync(ApplicationsUser user) =>
            new(
        ...
        private async Task<List<Claim>> GetClaimsAsync(ApplicationsUser user)
        {
